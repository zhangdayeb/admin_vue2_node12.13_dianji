...
<script>
  import {getVideoTypeListApi, getVideoTypeDelApi,getVideoTypeEditApi,getVideoTypeAddApi,getVideoTypeStatusApi,getVideoTypeIsShowApi} from '@/api/VideoTypeApi'
